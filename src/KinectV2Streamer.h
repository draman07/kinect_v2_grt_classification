...
#define INCOMING_KINECT_DATA_PORT 12345
#define OUTGOING_KINECT_DATA_PORT 12346
...
public:
    ...
    void openkinectConnection(unsigned int receiverIncomingDataPort = INCOMING_KINECT_DATA_PORT, unsigned int senderOutgoingDataPort = OUTGOING_KINECT_DATA_PORT,string ipAddress = LOCAL_HOST);
