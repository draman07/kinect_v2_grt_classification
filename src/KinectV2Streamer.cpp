#include "KinectV2Streamer.h"

KinectV2Streamer::KinectV2Streamer(){
    sendMessageCounterValue = 30;
    kinectConnectionOpen = false;
...
void KinectV2Streamer::openkinectConnection(unsigned int receiverIncomingDataPort, unsigned int senderOutgoingDataPort,string ipAddress){
    receiver.setup( receiverIncomingDataPort );
    sender.setup( ipAddress, senderOutgoingDataPort );
    kinectConnectionOpen = true;
}

void KinectV2Streamer::openOutgoingConnection(unsigned int outgoingDataPort,string ipAddress){
    streamer.setup( ipAddress, outgoingDataPort );
    streamingConnectionOpen = true;
    streamJointPositions = true;
}

void KinectV2Streamer::drawTrackedJoints(float x, float y, float width, float height){
    ofPushMatrix();
    ofTranslate(x, y);
...
/////////////////////////////////////// Getters ///////////////////////////////////////
bool KinectV2Streamer::getNewMessage(){
...
/////////////////////////////////////// Setters ///////////////////////////////////////
void KinectV2Streamer::trackAllJoints(bool trackStatus,unsigned int jointPos){
    clear();
...
void KinectV2Streamer::trackHead(bool trackStatus,unsigned int jointPos){
    switch( jointPos ){
...
void KinectV2Streamer::trackTorso(bool trackStatus,unsigned int jointPos){
    switch( jointPos ){
        case ALL_JOINT_POSITIONS:
...
void KinectV2Streamer::trackRightShoulder(bool trackStatus,unsigned int jointPos){
    switch( jointPos ){
        case ALL_JOINT_POSITIONS:
...
void KinectV2Streamer::trackLeftShoulder(bool trackStatus,unsigned int jointPos){
    switch( jointPos ){
        case ALL_JOINT_POSITIONS:
...
void KinectV2Streamer::trackRightElbow(bool trackStatus,unsigned int jointPos){
    switch( jointPos ){
        case ALL_JOINT_POSITIONS:
...
void KinectV2Streamer::trackLeftElbow(bool trackStatus,unsigned int jointPos){
    switch( jointPos ){
        case ALL_JOINT_POSITIONS:
...
void KinectV2Streamer::trackRightHand(bool trackStatus,unsigned int jointPos){
    switch( jointPos ){
        case ALL_JOINT_POSITIONS:
...
void KinectV2Streamer::trackLeftHand(bool trackStatus,unsigned int jointPos){
    switch( jointPos ){
        case ALL_JOINT_POSITIONS:
...
void KinectV2Streamer::trackRightHip(bool trackStatus,unsigned int jointPos){
    switch( jointPos ){
        case ALL_JOINT_POSITIONS:
        ...
        case WORLD_JOINT_POSITION:
            ...
            break;
        case BODY_JOINT_POSITION:
            rightHip.trackBodyJoint = trackStatus;f
...
void KinectV2Streamer::trackLeftHip(bool trackStatus,unsigned int jointPos){
    switch( jointPos ){
        case ALL_JOINT_POSITIONS:
...
void KinectV2Streamer::trackRightKnee(bool trackStatus,unsigned int jointPos){
    switch( jointPos ){
        case ALL_JOINT_POSITIONS:
...
void KinectV2Streamer::trackLeftKnee(bool trackStatus,unsigned int jointPos){
    switch( jointPos ){
        case ALL_JOINT_POSITIONS:
            rightKnee.trackBodyJoint = trackStatus;
            rightKnee.trackWorldJoint = trackStatus;
...
void KinectV2Streamer::trackRightFoot(bool trackStatus,unsigned int jointPos){
    switch( jointPos ){
        case ALL_JOINT_POSITIONS:
...
void KinectV2Streamer::trackLeftFoot(bool trackStatus,unsigned int jointPos){
    switch( jointPos ){
        case ALL_JOINT_POSITIONS:
...
void KinectV2Streamer::parseIncomingMessages(){
    
    if( !kinectConnectionOpen ) return;
...
void KinectV2Streamer::sendJointRequests(){
...
double KinectV2Streamer::euclideanDistance(vector< double > a,vector< double > b){
    double d = 0;
